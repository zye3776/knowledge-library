...
import type { Voice, PlaybackState } from "./types";
import { loadPlaybackState, savePlaybackState, saveParagraphsMeta } from "./state";
import { getPlayer } from "./player";
import { createClient, generateParagraphsAudio, requireApiKey } from "./tts";
import { splitIntoParagraphs, formatTime, createProgressBar } from "./text";
 ...
 */
export async function chunkedSpeak(options: ChunkedSpeakOptions): Promise<void> {
  const { text, outputDir, voice, model, rate, generateOnly, shouldStop } = options;
